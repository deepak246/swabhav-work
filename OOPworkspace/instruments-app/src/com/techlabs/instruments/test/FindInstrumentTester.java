package com.techlabs.instruments.test;
...
import com.techlabs.instruments.Builder;
import com.techlabs.instruments.Instrument;
import com.techlabs.instruments.InstrumentSpec;
import com.techlabs.instruments.InstrumentType;
import com.techlabs.instruments.Type;
import com.techlabs.instruments.Wood;
...
public class FindInstrumentTester {
	...
	public static void initializeInventory(Inventory inventory) {
		...
		properties.put("backWood", Wood.MAPLE);
		inventory.addInstrument("7108276", 2295.95, new InstrumentSpec(properties));
		
		properties.put("model", "SG 61 Reissue");
		properties.put("topWood", Wood.MAHOGANY);
		properties.put("backWood", Wood.MAHOGANY);
		inventory.addInstrument("82765501", 2295.95, new InstrumentSpec(properties));
